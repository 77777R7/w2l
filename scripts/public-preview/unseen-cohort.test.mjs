...
test('exclusion ledger includes tracked manifests, review notes, ignored reports, and archives', async () => {
  ...
  try {
    ...
    await mkdir(join(root, '.w2l/public-preview/unseen-100-sg/failed-run'), { recursive: true })
    ...
    await writeFile(join(root, '.w2l/public-preview/unseen-100-sg/failed-run/discovery.json'), JSON.stringify({ links: ['https://www.amazon.sg/dp/B000000005'] }))
