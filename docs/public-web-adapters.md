...
The [frozen integration run](evidence/amazon-adapter-integration-2026-09-23.md) has comparable three-round 10-product results and meets the speed/compact-response engineering gates at limited concurrency. Howard [signed the raw-HTML field review](evidence/amazon-field-review-signed-2026-09-23.json): 105/105 correct emitted core fields, 105/105 visible applicable core fields captured, and no recommendation intrusion across 30 reviewed captures. The ten-product gate is passed.

The [100-unseen-product Singapore holdout](evidence/amazon-holdout-100-2026-09-23.md) reached 456/456 accuracy on emitted ASIN/title/price/currency/seller values and 456/460 visible-field coverage; Howard reviewed the raw-page packet and found no field error or recommendation intrusion outside one honestly incomplete page. That page selected a different ASIN than requested, so the strict subject gate is **99/100, not passed**. Amazon remains beta; the 1000-page reliability gate has not run. The earlier Amazon.com cohort and the ten-page runner's one-round summary limitations are retained in the evidence.
